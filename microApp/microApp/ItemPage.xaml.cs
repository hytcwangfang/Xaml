...
namespace microApp
{
    ...
    public sealed partial class ItemPage : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            {
                this.previousId = item.PreviousId;
        ...
        {
            this.Frame.Navigate(typeof(ItemPage), this.nextid);
        }

        private void previousid_Click(object sender, RoutedEventArgs e)
        {
            //var item = await SampleDataSource.GetItemAsync(this.previousId);
            this.Frame.Navigate(typeof(ItemPage), this.previousId);
        }
    }
}